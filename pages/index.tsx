...
export default function home() {
  return (
    <>
      <Head>
        <title>Bereket Worku | Software Developer</title>
        <link rel="shortcut icon" href="./favicon-32x32.png" />
        <meta name="description" content="Bereket Worku | Software Developer" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Bereket Worku | Software Developer" />
